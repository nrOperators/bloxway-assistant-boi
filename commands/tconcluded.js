...
const trainingend = new Discord.MessageEmbed()
.setColor('GREEN')
.setTitle('Bloxway Training Concluded')
.setDescription(`The Training above have been concluded!`)
...
return message.guild.channels.cache.get('613159244077989909').send(trainingend)
}