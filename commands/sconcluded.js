...
exports.run = async (client, message) => {
    ...
    const shiftcembed = new Discord.MessageEmbed()
    .setColor('GREEN')
    .setTitle('Bloxway Shift Concluded')
    .setDescription(`The shift above have been concluded!`)
    ...
    return message.guild.channels.cache.get('613159244077989909').send(shiftcembed)
}